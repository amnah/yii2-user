 ...
 * @class \p2m\users\controllers\AuthController
 */
...
class AuthController extends \yii\web\Controller
{
	 ...
	 * @param \yii\authclient\BaseClient $client
	 * @return \p2m\users\models\UserAuth
	 */
	protected function initUserAuth($client)
	{
		/** @var \p2m\users\models\UserAuth $userAuth */
	 ...
	 * @param \yii\authclient\BaseClient $client
	 * @param \p2m\users\models\UserAuth $userAuth
	 */
