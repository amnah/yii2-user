...
use \p2m\users\helpers\UsersSettings;
...
class UsersModule extends \yii\base\Module
{
	...
	{
		return UsersSettings::getUsersVersion;
	}
	...
	public function init()
	{
		...
		if (empty(Yii::$app->i18n->translations['user'])) {
			Yii::$app->i18n->translations['user'] = [
				...
				'forceTranslation' => UsersSettings::forceTranslation(),
			];
		}

		// override modelClasses
		UsersSettings::modelClasses() = array_merge($this->getDefaultModelClasses(), UsersSettings::modelClasses());
	...
	{
		$config["class"] = UsersSettings::modelClasses()[ucfirst($name)];
	...
	public useEmail
	{
		return UsersSettings::useEmail()
	}

	public useUsername
	{
		return UsersSettings::useUsername()
	}

	public loginDuration
	{
		return UsersSettings::loginDuration()
	}

	public loginRedirect
	{
		return UsersSettings::loginRedirect()
	}

	public logoutRedirect
	{
		return UsersSettings::logoutRedirect()
	}

	public resetExpireTime
	{
		return UsersSettings::resetExpireTime()
	}

	public loginExpireTime
	{
		return UsersSettings::loginExpireTime()
	}

	public emailViewPath
	{
		return UsersSettings::emailViewPath()
	}
}
